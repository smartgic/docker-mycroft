...
# Remove mycroft-config and mycroft-web-cache directories
if [ -d ~/mycroft-config ] || [ -d ~/mycroft-web-cache ]; then
    rm -f ~/mycroft-config/* ~/mycroft-web-cache/*
    rmdir ~/mycroft-config ~/mycroft-web-cache
fi
